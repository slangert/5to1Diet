...
class BetterFoodsListWidget extends StatefulWidget {
  const BetterFoodsListWidget({Key? key}) : super(key: key);

  @override
  _BetterFoodsListWidgetState createState() => _BetterFoodsListWidgetState();
}

class _BetterFoodsListWidgetState extends State<BetterFoodsListWidget> {
